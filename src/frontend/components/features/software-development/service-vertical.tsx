            ...
            <div className="container mx-auto max-w-[1440px] px-6">
                <div className={`flex flex-col lg:flex-row gap-16 items-center ${align === 'right' ? 'lg:flex-row-reverse' : ''}`}>
                    <div className="flex-1 space-y-8">
                        <span className="text-primary font-bold text-lg mb-4 block tracking-wide">
                            Software Solution
                        </span>
                        <h2 className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.8] opacity-90">{title}</h2>
