...
const techCategories = [
    {
        ...
        technologies: ["C++", "C#", ".NET Core", "Java", "Electron", "Rust", "Qt", "Tauri"]
    },
    {
        category: "Backend & Microservices",
        color: "from-green-500 to-emerald-500",
        technologies: ["Node.js", "Go", "Python", "Kubernetes", "Docker", "gRPC", "RabbitMQ", "Kafka"]
    },
    {
        category: "Cloud Native",
        color: "from-purple-500 to-pink-500",
        technologies: ["AWS Lambda", "Azure Functions", "Google Cloud Run", "Terraform", "Serverless", "DynamoDB"]
    },
    {
        category: "Enterprise Tech",
        color: "from-orange-500 to-red-500",
        technologies: ["Oracle", "SAP", "Salesforce Apex", "SharePoint", "Dynamics 365", "IBM Cloud"]
    },
    {
        category: "Database & Big Data",
        color: "from-indigo-500 to-purple-500",
        technologies: ["PostgreSQL", "MongoDB", "Redis", "Elasticsearch", "Snowflake", "Cassandra"]
    },
    {
        category: "Testing & DevOps",
        color: "from-pink-500 to-rose-500",
        technologies: ["Jenkins", "GitLab CI", "Selenium", "Jest", "Cypress", "CircleCI"]
    }
]
            ...
            <div className="container mx-auto max-w-[1440px] px-6 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-5xl md:text-7xl font-black uppercase leading-none mb-6">
                        Code <span className="text-primary">Foundry</span>
                    </h2>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        Building robust, scalable software with industrial-grade technologies
                    </p>
                </motion.div>
