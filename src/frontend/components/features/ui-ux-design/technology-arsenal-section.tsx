...
const techCategories = [
    {
        ...
        technologies: ["Figma", "Sketch", "Adobe XD", "Photoshop", "Illustrator", "InVision", "Marvel", "Framer"]
    },
    {
        category: "Prototyping & Animation",
        color: "from-green-500 to-emerald-500",
        technologies: ["Principle", "ProtoPie", "After Effects", "Lottie", "Origami Studio", "Axure RP"]
    },
    {
        category: "User Research",
        color: "from-purple-500 to-pink-500",
        technologies: ["Maze", "UserTesting", "Hotjar", "Optimal Workshop", "Lookback", "Typeform"]
    },
    {
        category: "Collaboration",
        color: "from-orange-500 to-red-500",
        technologies: ["Miro", "Zeplin", "Abstract", "Notion", "Slack", "Jira"]
    },
    {
        category: "Design Systems",
        color: "from-indigo-500 to-purple-500",
        technologies: ["Storybook", "Zeroheight", "Specify", "Knapsack", "Pattern Lab", "Supernova"]
    },
    {
        category: "3D & Web",
        color: "from-pink-500 to-rose-500",
        technologies: ["Spline", "Blender", "Cinema 4D", "Webflow", "Three.js", "Rive"]
    }
]
            ...
            <div className="container mx-auto max-w-[1440px] px-6 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-5xl md:text-7xl font-black uppercase leading-none mb-6">
                        Design <span className="text-primary">Ecosystem</span>
                    </h2>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        Crafting world-class experiences with the best tools in the industry
                    </p>
                </motion.div>
