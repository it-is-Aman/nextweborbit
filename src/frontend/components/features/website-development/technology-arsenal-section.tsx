...
const techCategories = [
    {
        ...
        technologies: ["React", "Next.js", "Vue.js", "Nuxt", "Svelte", "Angular", "Astro", "Gatsby"]
    },
    {
        category: "CMS Platforms",
        color: "from-green-500 to-emerald-500",
        technologies: ["WordPress", "Shopify", "Webflow", "Strapi", "Sanity", "Contentful", "Drupal", "Wix"]
    },
    {
        category: "Backend & API",
        color: "from-purple-500 to-pink-500",
        technologies: ["Node.js", "Express", "NestJS", "Python Django", "PHP Laravel", "GraphQL", "Firebase"]
    },
    {
        category: "Styling & UI",
        color: "from-orange-500 to-red-500",
        technologies: ["Tailwind CSS", "Sass/SCSS", "Styled Components", "Framer Motion", "GSAP", "Material UI"]
    },
    {
        category: "Database",
        color: "from-indigo-500 to-purple-500",
        technologies: ["PostgreSQL", "MySQL", "MongoDB", "Supabase", "Prisma", "PlanetScale"]
    },
    {
        category: "DevOps & Hosting",
        color: "from-pink-500 to-rose-500",
        technologies: ["Vercel", "Netlify", "AWS Amplify", "Docker", "DigitalOcean", "Cloudflare"]
    }
]
            ...
            <div className="container mx-auto max-w-[1440px] px-6 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-5xl md:text-7xl font-black uppercase leading-none mb-6">
                        Digital <span className="text-primary">Canvas</span>
                    </h2>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        Building the web with the latest and greatest frameworks
                    </p>
                </motion.div>
