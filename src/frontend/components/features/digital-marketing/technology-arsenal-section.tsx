...
const techCategories = [
    {
        ...
        technologies: ["Google Analytics 4", "GTM", "Mixpanel", "Hotjar", "Semrush", "Ahrefs"]
    },
    {
        category: "Advertising",
        color: "from-green-500 to-emerald-500",
        technologies: ["Google Ads", "Meta Ads", "LinkedIn Ads", "TikTok Ads", "Programmatic", "Demandbase"]
    },
    {
        category: "CRM & Automation",
        color: "from-purple-500 to-pink-500",
        technologies: ["HubSpot", "Salesforce", "Marketo", "Mailchimp", "Klaviyo", "Zapier"]
    },
    {
        category: "Content & Design",
        color: "from-orange-500 to-red-500",
        technologies: ["Canva", "Adobe CC", "Figma", "WordPress", "Webflow", "Copy.ai"]
    },
    {
        category: "Social Media",
        color: "from-indigo-500 to-purple-500",
        technologies: ["Hootsuite", "Buffer", "Sprout Social", "Later", "Brandwatch", "BuzzSumo"]
    },
    {
        category: "SEO Tools",
        color: "from-pink-500 to-rose-500",
        technologies: ["Moz", "Screaming Frog", "Yoast", "SurferSEO", "Clearscope", "AnswerThePublic"]
    }
]
            ...
            <div className="container mx-auto max-w-[1440px] px-6 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-5xl md:text-7xl font-black uppercase leading-none mb-6">
                        Growth <span className="text-primary">Engine</span>
                    </h2>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        Powering campaigns with the industry&apos;s most advanced tools
                    </p>
                </motion.div>
