...
const WalmartLogo = () => (
    <svg viewBox="0 0 200 60" className="h-9 w-auto text-neutral-400 hover:text-neutral-900 transition-colors duration-300 fill-current">
...
const LinkedInLogo = () => (
    <svg viewBox="0 0 200 60" className="h-9 w-auto text-neutral-400 hover:text-neutral-900 transition-colors duration-300 fill-current">
        ...
        <text x="135" y="38" className="font-sans font-bold text-3xl fill-[#FAF9F6]">in</text>
    </svg>
)
...
export default function ClientsSection() {
    ...
    return (
        <section ref={sectionRef} className="py-16 bg-[#FAF9F6] overflow-hidden relative border-t border-neutral-200/60 border-b border-neutral-200/60">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
                <div className="text-center">
                    <h2 className="text-sm font-semibold tracking-[0.2em] text-neutral-500 uppercase">
            ...
            <div className="w-full relative flex overflow-hidden">
                {/* Smoky masks */}
                <div className="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-[#FAF9F6] to-transparent z-20 pointer-events-none" />
                <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-[#FAF9F6] to-transparent z-20 pointer-events-none" />
